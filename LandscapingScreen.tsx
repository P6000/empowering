...
const LandscapingScreen = ({ navigation }: any) => {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <Text style={styles.content}>
          To provide landscaping services for new and established gardens with professional certification.
        </Text>
        ...
        <Text style={styles.content}>• Fixed structures (fountains, statues, benches)</Text>
        <Text style={styles.content}>• Balancing plants and trees in a garden</Text>
        <Text style={styles.content}>• Aesthetics of plant shapes and colors</Text>
        <Text style={styles.content}>• Garden layout and design principles</Text>

        <TouchableOpacity 
          style={styles.enrollButton}
          onPress={() => navigation.navigate('Contact', { course: 'Landscaping' })}
        >
