    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <Text style={styles.content}>
          To provide first aid awareness and basic life support for professional certification.
        </Text>

        <Text style={styles.sectionTitle}>What You Will Learn</Text>
        <Text style={styles.content}>• Wounds and bleeding treatment</Text>
        <Text style={styles.content}>• Burns and fractures management</Text>
        <Text style={styles.content}>• Emergency scene management</Text>
        <Text style={styles.content}>• CPR and basic life support</Text>

        <TouchableOpacity 
          style={styles.enrollButton}
          onPress={() => navigation.navigate('Contact', { course: 'First Aid' })}
        >
