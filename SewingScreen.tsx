...
const SewingScreen = ({ navigation }: any) => {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <Text style={styles.content}>
          To provide alterations and new garment tailoring services for professional certification.
        </Text>

        <Text style={styles.sectionTitle}>What You Will Learn</Text>
        <Text style={styles.content}>• Types of stitches and sewing techniques</Text>
        <Text style={styles.content}>• Threading and operating sewing machines</Text>
        <Text style={styles.content}>• Sewing buttons, zips, hems and seams</Text>
        <Text style={styles.content}>• Professional garment alterations</Text>
        <Text style={styles.content}>• Designing and sewing new garments</Text>

        <TouchableOpacity 
          style={styles.enrollButton}
          onPress={() => navigation.navigate('Contact', { course: 'Sewing' })}
        >
