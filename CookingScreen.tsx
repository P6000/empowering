...
const CookingScreen = ({ navigation }: any) => {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <Text style={styles.content}>
          To prepare and cook nutritious family meals for domestic employment.
        </Text>
        ...
        <Text style={styles.content}>• Planning balanced meals and menu creation</Text>
        <Text style={styles.content}>• Tasty and nutritious recipes preparation</Text>
        <Text style={styles.content}>• Food safety and proper cooking techniques</Text>

        <TouchableOpacity 
          style={styles.enrollButton}
          onPress={() => navigation.navigate('Contact', { course: 'Cooking' })}
        >
